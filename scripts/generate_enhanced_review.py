...
使用现有免费数据源 + 增强的 LLM Prompt 生成更专业的复盘报告
"""
...
<body>
  <div class="container">
    ...
    <footer class="footer">
      ...
      <p>数据来源：AkShare（免费数据源）, LLM 深度分析</p>
...
def main():
    ...
    md_filename = output_dir / f'market-review-{date_code}-enhanced.md'
    ...
    html_filename = output_dir / f'market-review-{date_code}-enhanced.html'
    ...
    print()
    print('🎯 优化内容：')
    print('1. 增强的 LLM Prompt - 更专业、深入的分析')
    print('2. 详细的数据解读 - 每个观点有数据支撑')
    print('3. 深度板块分析 - 驱动因素、持续性判断')
    print('4. 具体操作建议 - 进攻/防守策略、仓位建议')
    print()
